...
func EmptyUpdateProject() *UpdateProject {
	return &UpdateProject{}
}

func (u *UpdateProject) GetValue() *UpdateProject {
	return u
}

func (u *UpdateProject) ValidateErrors(errs validator.ValidationErrors) ([]string, error) {
	var msgs []string
